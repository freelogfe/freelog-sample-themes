...
export const freelogEntrances: freelogEntranceItem[] = [
  { label: "freelog fl-icon-a-featherlogo5", url: "https://www.freelog.cn/" },
  {
    label: "关于freelog",
    url: "https://freelog4.freelog.cn/$freelog-61f252ef6fe5c1002e2c7b4b=/home_id=62d0d202456ff0002e3295ab"
  },
  // TODO 到时候上线的话这里的url要改一下
  {
    label: "使用此主题",
    url: "https://console.freelog.cn/resource/details/61f252dfa513d2002f2abc85"
  },
  { label: "浏览更多主题", url: "https://console.freelog.cn/market?query=主题" }
];
