      ...
      >
        <transition name="slide-down">
          <div class="w-100p mw-1172 flex-column align-center" v-if="contentShow">
            ...
            <div className="content w-100p mw-800 my-40">
              <p
                className="fs-18 lh-24 text-breakAll"
                v-for="(item, index) in imageInfo?.content"
                :key="'item' + index"
              >
                {{ item }}
              </p>
            ...
            <div class="w-100p mw-800 fs-16 lh-32 mt-56 fc-less">{{ imageInfo?.intro }}</div>
